...
# ================== CONFIG & STYLE ==================
st.set_page_config(page_title="EGX Sniper Elite v8", layout="wide")
...
with tab2:
    if st.button("بدء فحص أقوى فرص السوق 🔍"):
        ...
        for r in all_d:
            ...
            # إظهار الأسهم التي لديها سكور قوي فقط في الماسح
